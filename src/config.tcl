...
set ::env(DESIGN_NAME) scan_wrapper_341419328215712339
...
set ::env(VERILOG_FILES) "$::env(DESIGN_DIR)/user_module_341419328215712339.v \
$::env(DESIGN_DIR)/scan_wrapper_341419328215712339.v"
